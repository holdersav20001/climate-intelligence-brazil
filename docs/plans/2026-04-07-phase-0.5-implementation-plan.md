...
DATABASE_URL=postgresql://climate_intel:YOURPASSWORD@postgres:5432/climate_intel

# Our app reads this (connects to climate schema — articles, findings, contacts)
CLIMATE_DATABASE_URL=postgresql://climate_intel:YOURPASSWORD@postgres:5432/climate_intel?options=-csearch_path%3Dclimate
...
```bash
CLIMATE_DATABASE_URL="postgresql://climate_intel:YOURPASSWORD@localhost:5432/climate_intel?options=-csearch_path%3Dclimate" \
